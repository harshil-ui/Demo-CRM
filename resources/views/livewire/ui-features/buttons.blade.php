                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Add class <code>.btn-{color}</code> for buttons in theme
                                        colors</p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Add class <code>.btn-outline-{color}</code> for outline
                                        buttons</p>
                                    <div class="template-demo">
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Add class <code>.btn-inverse-{color} for inverse
                                            buttons</code></p>
                                    <div class="template-demo">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Add class <code>.btn-icon</code> for buttons with only
                                        icons</p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <div class="template-demo">
                                        <div class="btn-group pb-2 pb-lg-0" role="group"
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Wrap icon and text inside <code>.btn-icon-text</code>
                                        and use <code>.btn-icon-prepend</code>
